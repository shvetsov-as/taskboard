...
public class UserDetailsImpl implements UserDetails {// For custom mapping User to UserDetails with creating static map method (not needed if we use mapstruct)
